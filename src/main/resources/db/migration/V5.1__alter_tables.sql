...
ALTER TABLE startup DROP COLUMN investmentphaseid;
ALTER TABLE startup ADD COLUMN investmentphaseid int REFERENCES investmentphase(id)  ON DELETE RESTRICT;
...
ALTER TABLE founder ADD COLUMN countryid bigint REFERENCES country(id);

ALTER TABLE founder RENAME COLUMN name to firstname;
ALTER TABLE founder ADD COLUMN lastname varchar;
ALTER TABLE founder RENAME COLUMN role to position;

ALTER TABLE boardmember RENAME COLUMN name to firstname;
ALTER TABLE boardmember ADD COLUMN lastname varchar;
