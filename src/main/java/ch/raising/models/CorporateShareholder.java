...
public class CorporateShareholder extends StartupMember{
	...
	@Builder
	private CorporateShareholder(long id, long startupId, long corporateBodyId, int equityShare, String website, String firstName, String lastName, long countryId) {
